...
import firstFarmCrop from "../../assets/images/vertical-farm/first-farm-crop.png";
...
import flagFive from "../../assets/images/vertical-farm/level-five.png";

export default function FirstSkyFarm() {
    ...
    <>
      ...
      <Box p={"50px"}>
        <Stack
          ...
          height={"100%"}
        >
          <Link to={`/sustainable-design/${verticalFarmId}`}>
          ...
          <Link to={`/first-sky-farm-crop/${verticalFarmId}`}>
