...
import FruitsBySeasonHead from "../../assets/images/vertical-farm/fruits-by-season.png";
import FruitBySeasonBG from "../../assets/images/vertical-farm/fruits-by-season-bg.png";
...
export default function FruitsBySeason() {
        ...
        <>
            ...
            <Stack direction={"row"} alignItems={"center"} justifyContent={"center"} height={"100%"} m={"50px"}>
                ...
                <div style={{
                    ...
                    <img src={FruitsBySeasonHead} style={{
                        width: "328px",
                        height: "69px"
                    }} />
                    </div>
                    ...
                    <Box mt={4}>
                        ...
                        <Box width={"100%"} display={"flex"} justifyContent={"center"} mt={2}>
                            <button
                                ...
                                onClick={()=>{
                                    console.log('Add Fruits Button======>', cropEdited);
                                }}
                            >
                                Add Fruits
                            </button>
