...
import sustainableDesign from "../../assets/images/vertical-farm/sustainable-designed.png";
...
import flagFourth from "../../assets/images/vertical-farm/level-fourth.png"
    ...
    <>
      ...
      <Box p={"50px"}>
        <Stack
          ...
          height={"100%"}
        >
          <Link to={`/up-cycled-materials/${verticalFarmId}`}>
...
<div style={{ position: "absolute", top: -25, left: 250 }}>
          ...
          <Link to={`/first-sky-farm/${verticalFarmId}`}>
