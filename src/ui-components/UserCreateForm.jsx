...
export default function UserCreateForm(props) {
  ...
  return (
    ...
    >
      ...
      >
        <option
          children="Clean energy designer"
          value="CLEAN_ENERGY_DESIGNER"
          {...getOverrideProps(overrides, "avataroption0")}
        ></option>
        <option
          children="Fixer"
          value="FIXER"
          {...getOverrideProps(overrides, "avataroption1")}
        ></option>
        <option
          children="Garbage collector"
          value="GARBAGE_COLLECTOR"
          {...getOverrideProps(overrides, "avataroption2")}
        ></option>
        <option
          children="Mountain climber"
          value="MOUNTAIN_CLIMBER"
          {...getOverrideProps(overrides, "avataroption3")}
        ></option>
        <option
          children="Scraap 1"
          value="SCRAAP_1"
          {...getOverrideProps(overrides, "avataroption4")}
        ></option>
        <option
          children="Thinker"
          value="THINKER"
          {...getOverrideProps(overrides, "avataroption5")}
        ></option>
        <option
          children="Totto kumari"
          value="TOTTO_KUMARI"
          {...getOverrideProps(overrides, "avataroption6")}
        ></option>
        <option
          children="Upcycle"
          value="UPCYCLE"
          {...getOverrideProps(overrides, "avataroption7")}
        ></option>
      </SelectField>
      <Flex
