...
export default function ActivityFeedCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new ActivityFeed(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "ActivityFeedCreateForm")}
      {...rest}
    >
      <TextField
        label="Content"
